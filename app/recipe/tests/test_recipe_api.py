...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipes_limited_to_user(self):
        """Test retriving reciped for user"""
        user2 = get_user_model().objects.create_user(
            'tetestst@testtest.com',
            'ttestesttest'
        )
    ...
    def test_create_recipe_with_ingredients(self):
        """Test creating recipe with ingrdedient"""
        ...
        # self.assertEqual(res.data['ingredients'], status)
        self.assertEqual(res.status_code, status.HTTP_201_CREATED)
        recipe = Recipe.objects.get(id=res.data['id'])
    ...
    def test_partial_update_recipe(self):
        """Test updatinh a recipe with patch"""
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe2 = sample_recipe(self.user, title='Auberginewith tahini')
        tag1 = sample_tag(self.user, name='Vegan')
    ...
    #     recipe3 = sample_recipe(self.user, title='Stake and mushroom')
